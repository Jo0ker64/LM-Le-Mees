...
final class Version20240813154702 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salade_bar ADD titre VARCHAR(255) NOT NULL, ADD ingredientVARCHAR(255) NOT NULL, ADD prix VARCHAR(255) NOT NULL, DROP title, DROP ingredient, DROP price');
        $this->addSql('ALTER TABLE pizza_tomate ADD titre VARCHAR(255) NOT NULL, ADD ingredientVARCHAR(255) NOT NULL, ADD prix VARCHAR(255) NOT NULL, DROP title, DROP ingredient, DROP price');
        $this->addSql('ALTER TABLE formules ADD titre VARCHAR(255) NOT NULL, ADD ingredientVARCHAR(255) NOT NULL, ADD prix VARCHAR(255) NOT NULL, DROP title, DROP ingredient, DROP price');
        $this->addSql('ALTER TABLE pizza_creme ADD titre VARCHAR(255) NOT NULL, ADD ingredientVARCHAR(255) NOT NULL, ADD prix VARCHAR(255) NOT NULL, DROP title, DROP ingredient, DROP price');
        $this->addSql('ALTER TABLE pizza_chef ADD titre VARCHAR(255) NOT NULL, ADD ingredientVARCHAR(255) NOT NULL, ADD prix VARCHAR(255) NOT NULL, DROP title, DROP ingredient, DROP price');
        $this->addSql('ALTER TABLE gourmandises ADD titre VARCHAR(255) NOT NULL, ADD ingredientVARCHAR(255) NOT NULL, ADD prix VARCHAR(255) NOT NULL, DROP title, DROP ingredient, DROP price');
        $this->addSql('ALTER TABLE snacking ADD titre VARCHAR(255) NOT NULL, ADD ingredientVARCHAR(255) NOT NULL, ADD prix VARCHAR(255) NOT NULL, DROP title, DROP ingredient, DROP price');
    }
}
